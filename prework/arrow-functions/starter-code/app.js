...
// TODO: Uncomment the following line of code to see the output in the browser console
//console.log(joe.scope()); attempt to log value of a void function
joe.scope();
Student.prototype.scopeArrow = () => console.log(this);

// TODO: Uncomment the following line of code to see the output in the browser console
//console.log(joe.scopeArrow()); attempt to log value of a void function
joe.scopeArrow();
// TODO: Write a COMMENT below to answer the following questions.
//1. What is "this" when joe.scope() is invoked? 
// {age: "Schmoe",hometown: 100,name: "Joe"} line 180 
// 2. What is "this" when joe.scopeArrow() is invoked?
// window  
// 3. Explain why "this" is different when an arrow function is used.
// arrow function always bound to the value of this in the closest non-arrow parent function.
